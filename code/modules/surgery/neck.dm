...
/datum/surgery_step/brainstem/clean_chips
	...
	allowed_tools = list(
		...
		/obj/item/surgical/hemostat_primitive = 50) //Surprisingly, claws are kind of okay at picking things out.
...
/datum/surgery_step/brainstem/realign_tissue
	...
	allowed_tools = list(
		/obj/item/surgical/hemostat = 100,
		/obj/item/surgical/hemostat_primitive = 50) //Claws. Good for digging, not so much for moving.
